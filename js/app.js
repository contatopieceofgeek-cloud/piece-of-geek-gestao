...
function renderTopbarActions(){
  ...
  else if(currentTab==='produtos') el.innerHTML = `<button class="btn ghost" onclick="produtosView=(produtosView==='diagnostico'?'lista':'diagnostico'); renderContent(); renderTopbarActions();">${produtosView==='diagnostico'?'Voltar à lista':'Diagnóstico'}</button> <button class="btn primary" onclick="openProductModal()">+ Novo produto</button>`;
